    ...
    <div class="space-y-4 p-4">
        ...
        <section class="space-y-2">
            ...
            <div v-if="accounts.length" class="grid grid-cols-2 gap-2">
                <AccountTile
                    v-for="account in accounts.filter((a) => !a.is_archived)"
                    :key="account.id"
                    :name="account.name"
                    :type="account.type"
            ...
            >
                <Button as-child class="min-h-11">
                    <Link :href="createAccountRoute.url()">
                ...
                <li v-for="item in recent" :key="item.id">
                    <TransactionRow
                        ...
                        :title="
                            ...
                            'Tanpa deskripsi'
                        "
                        :meta="`${item.category ?? 'Tanpa kategori'} · ${item.account} · ${dateLabel.format(asLocalDate(item.date))}`"
                        :amount="item.amount"
